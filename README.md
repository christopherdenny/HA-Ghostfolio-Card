...
### Overview Tab
Real-time portfolio snapshot with current value, performance, and account breakdown.

![Overview Tab](./Accounts.png)

The Overview tab displays:
- **Current Value** - Your total portfolio value in real-time
- **Net Performance** - Dollar gain/loss and percentage return vs cost basis
- **Total Invested** - Capital you've put into investments
- **Accounts** - Color-coded breakdown of each account with allocation bars

### Holdings Tab
Ranked list of all investments with expandable details for each position.

![Holdings Tab](./Holdings.png)

The Holdings tab shows:
- **Ranked Positions** - Holdings sorted by value (largest first)
- **Quick Stats** - Name, symbol, asset class, sector for each holding
- **Allocation %** - What percentage each holding represents in your portfolio
- **Click to Expand** - See detailed metrics (price, gain/loss, cost basis, dividends)

### Holdings Detail (Expanded)
Click any holding to see comprehensive metrics.

![Holdings Detail](./Holdings_Details.png)

Expanded holding shows:
- **Current Price** - Market price per unit
- **Gain/Loss** - Dollar amount and percentage (color-coded: green/red)
- **Cost Basis** - Total investment and price per unit
- **Sector** - Security classification
- **Dividends** - Total dividends received (if applicable)

### Charts Tab
Visual allocation breakdowns using interactive donut charts.

![Charts Tab](./Charts.png)

The Charts tab displays:
- **Sector Allocation** - How your portfolio is distributed across sectors (tech, healthcare, etc.)
  - ETFs and mutual funds grouped as "Diversified"
  - Individual stocks shown by their sector
- **Account Allocation** - Which accounts hold what percentage of your portfolio
  - Useful for seeing if you're overweighting one account
...
- **Net Performance** - Total profit/loss in dollars
- **Return (ROAi)** - Return on invested amount as percentage
- **CAGR** - Compound Annual Growth Rate (with tooltip explaining metric)
- **Total Value** - Current portfolio value
- **Total Invested** - Capital deployed
- **Cash / Emergency Fund** - Liquid investable assets
